package  {
	...
	*/
	...
	public class LaserBall_v2Cluster_Level_2 extends Sprite implements IPoolable, IGameObject {
		...
		public static var _shotRate : int = 8;
		
		
		// Constructor
		public function LaserBall_v2Cluster_Level_2() {
		...
		public function update() : void {
			...
			for (var i : int = -1; i < 2; i ++) {
				...
				if (i == 0) {
					tempRef.setSpeed(0, tempRandomSpeed * .75);
					tempRef.scaleX = .75;
					tempRef.scaleY = .75;
				} else {
