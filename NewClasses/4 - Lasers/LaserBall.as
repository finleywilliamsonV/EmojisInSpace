package  {
	...
	public class LaserBall extends Sprite implements IPoolable, IGameObject {
		...
		public static var _shotRate : int = 4;
		
		
		// Constructor
		public function LaserBall() {
			
			_destroyed = true;
			
			_shapeA.graphics.beginFill(0x7BFFFF, 1);
			_shapeA.graphics.drawCircle(0,0, 15);
			_shapeA.graphics.endFill();
			
			_shapeA.graphics.beginFill(0x66FFCC, 1);
			_shapeA.graphics.drawCircle(0,0, 14);
			_shapeA.graphics.endFill();
			
			_shapeB.graphics.beginFill(0x7BFFFF, 1);
			_shapeB.graphics.drawCircle(0,0, 12);
