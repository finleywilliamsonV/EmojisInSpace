package  {
	...
	*/
	...
	public class LaserBall_v3Cluster extends Sprite implements IPoolable, IGameObject {
		...
		// Constructor
		public function LaserBall_v3Cluster() {
		...
		public function addExtraLasers() : void {
			...
			for (var i : int = -1; i < 2; i += 2) {
				...
				tempRef.x = setX;
				tempRef.y = setY;
				tempRef.setSpeed(i * 4, tempRandomSpeed/2);
