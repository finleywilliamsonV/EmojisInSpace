package  {
	...
	public class Level_7 implements ILevel, IPoolable {
		...
		public function update():void {
			...
			if (tickCount == 1) {					
				...
				var tempRef = ObjectPool.instance.getObj(Situation) as Situation;
				tempRef.setup(pRef, E_Basic, 1, 20, 100);
				
			} else if (tickCount == 200) {			
				
				var tempRef = ObjectPool.instance.getObj(Situation) as Situation;
				tempRef.setup(pRef, E_Basic, 1, 10, 100);
				
			} else if (tickCount == 300) {			
				
				var tempRef = ObjectPool.instance.getObj(Situation) as Situation;
				tempRef.setup(pRef, E_Basic, 1, 5, 100);
				
			} else if (tickCount == 400) {			
				
				var tempRef = ObjectPool.instance.getObj(Situation) as Situation;
				tempRef.setup(pRef, E_Basic, 10, 25, 100);
				
			} else if (tickCount == 500) {			
				
				var tempRef = ObjectPool.instance.getObj(Situation) as Situation;
				tempRef.setup(pRef, E_Basic, 1, 23, 100);
				
			} else if (tickCount == 600) {			
				
				var tempRef = ObjectPool.instance.getObj(Situation) as Situation;
				tempRef.setup(pRef, E_Basic, 1, 3, 400);
				
				tempRef = ObjectPool.instance.getObj(Situation) as Situation;
				tempRef.setup(pRef, E_Basic, 5, 13, 400);
				...
				var tempRef = ObjectPool.instance.getObj(Situation) as Situation;
				tempRef.setup(pRef, E_Basic, 1, 2, 200);
				
				tempRef = ObjectPool.instance.getObj(Situation) as Situation;
				tempRef.setup(pRef, E_Basic, 2, 9, 200);
				
				tempRef = ObjectPool.instance.getObj(Situation) as Situation;
				tempRef.setup(pRef, E_Basic, 2, 7, 200);
		...
		public function changeLevels() : void {
			pRef.nextLevel(ObjectPool.instance.getObj(Level_8) as Level_8);
		}
